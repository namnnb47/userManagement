...
<html>
    ...
    <body onload="myFunction()">
        ...
        <h1>Search Page</h1>
        <a href="DispatchController?btAction=Insert">Create A New Account </a> <br>
        <a href="promotionList.jsp">View Promotion List </a> <br>
        <a href="DispatchController?btAction=History">View Promotion History</a>
        ...
        <a href="DispatchController?btAction=Search&searchValue=${searchValue}">All</a>
        <c:forEach var="roleDto" items="${listRole}">

          &emsp;  <a href="DispatchController?btAction=Search&roleId=${roleDto.roleId}&searchValue=${searchValue}">${roleDto.roleName}</a> &emsp;
