...
public class DeleteController extends HttpServlet {
    ...
    private static final String SUCCESS = "DispatchController";
        ...
        try {
            if (user == null) {
                ...
                if (userName.equals(admim)) {
                    request.setAttribute("DELETEADMIN", "CAN'T DELETE YOURSELF");
                } else {
            ...
            log(" Error at DeleteController _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log(" Error at DeleteController _ NamingException" + ex.getMessage());
        } finally {
