...
import namnnb.errors.UpdateErrors;
...
public class UpdateController extends HttpServlet {
    ...
    private static final String ERRORS_PAGE = "PreUpdateController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("UpdateController _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log("UpdateController _ NamingException" + ex.getMessage());
        } catch (NoSuchAlgorithmException ex) {
            log("UpdateController _ NoSuchAlgorithmException" + ex.getMessage());
        } finally {
