...
import namnnb.daos.PromotionDAO;
...
public class ViewHistoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            result = dao.loadHistory();
            request.setAttribute("HISTORY", result);
        } catch (SQLException ex) {
            log("ViewHistoryController _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log("ViewHistoryController _ NamingException" + ex.getMessage());
        } finally {
