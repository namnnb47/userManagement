 ...
 * @author Admin
 */
@WebServlet(name = "PreUpdateController", urlPatterns = {"/PreUpdateController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (username.equals(ad)) {
                url = "DispatchController?btAction=Search";
            ...
            log("PreUpdateController _ SQLException" + ex.getMessage());
        } catch (NamingException ex) {
            log("PreUpdateController _ NamingException" + ex.getMessage());
        } finally {
